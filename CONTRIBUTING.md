...
Follow the [KATforge Engineering Handbook](https://katforge.atlassian.net/wiki/spaces/KFE/pages/393217/Engineering+Workflow).

## Workflow

- Start repository work in an Imp workset.
- Include the Jira key when one exists, for example `feature/KFE-123-short-name`.
...
See the detailed [Git and Commit Standard](https://katforge.atlassian.net/wiki/spaces/KFE/pages/458753/Git+and+Commit+Standard)
and [Pull Request Standard](https://katforge.atlassian.net/wiki/spaces/KFE/pages/458774/Pull+Request+Standard).
